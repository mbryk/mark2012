...
class m120912_211128_add_blog extends CDbMigration
{
	public function up()
	{
                $this->execute("CREATE TABLE IF NOT EXISTS `blog_sort` (
...
CREATE TABLE IF NOT EXISTS `tbl_post` (
  ...
  `type` enum('post','org','quote') COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
");
	...
	{
		echo "m120912_211128_add_blog does not support migration down.\n";
		return false;
	}
