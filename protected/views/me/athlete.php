...
<div class="tabbable tabs-right">
              <ul class="nav nav-tabs">
                <li class="active"><a href="#TM" data-toggle="tab">Tough Mudder</a></li>
                <li class=""><a href="#MM" data-toggle="tab">Marathon Man</a></li>
                <li class=""><a href="#NYJ" data-toggle="tab">Football</a></li>
                <li class=""><a href="#WP" data-toggle="tab">Skier</a></li>
                <li class=""><a href="#VS" data-toggle="tab">Misc</a></li>
              </ul>
...
<!--                    
                    <div style="position:relative; width:300px; margin: 0 auto">
                             ...
                             <a class="thumbnail span-3" href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro1.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="text-decoration:none; float:none; margin-left:20px">
                                 <img src="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Tough_Mudder2.png" alt="">
                                 <h3 style="text-align:center">View Gallery</h3>
                             </a>
                        </div>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro2.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro3.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro4.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro5.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro6.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro7.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro8.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro9.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro10.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro11.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro12.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro13.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro14.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Electro15.png" rel="shadowbox[Mudder]" title="Electro Therapy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Finish1.png" rel="shadowbox[Mudder]" title="Finish" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Finish2.png" rel="shadowbox[Mudder]" title="Finish" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Finish3.png" rel="shadowbox[Mudder]" title="Finish" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Finish4.png" rel="shadowbox[Mudder]" title="Finish" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Freezing.png" rel="shadowbox[Mudder]" title="Freezing" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Ladder.png" rel="shadowbox[Mudder]" title="Ladder" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Ladder2.png" rel="shadowbox[Mudder]" title="Ladder" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Ladder3.png" rel="shadowbox[Mudder]" title="Ladder" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Ladder4.png" rel="shadowbox[Mudder]" title="Ladder" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Ladder5.png" rel="shadowbox[Mudder]" title="Ladder" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Muddy1000.png" rel="shadowbox[Mudder]" title="Muddy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Muddy2.png" rel="shadowbox[Mudder]" title="Muddy" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Post_Headshot.png" rel="shadowbox[Mudder]" title="Me" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Post_Pose.png" rel="shadowbox[Mudder]" title="Us" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Start.png" rel="shadowbox[Mudder]" title="Start" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Tough_Mudder.png" rel="shadowbox[Mudder]" title="" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Tough_Mudder2.png" rel="shadowbox[Mudder]" title="" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Wounded1.png" rel="shadowbox[Mudder]" title="Wounded Warrior" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Wounded2.png" rel="shadowbox[Mudder]" title="Wounded Warrior" style="display:none"></a>
                    <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/TM/Wounded3.png" rel="shadowbox[Mudder]" title="Wounded Warrior" style="display:none"></a>
